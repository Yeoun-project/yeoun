...
const Circle = ({ size = 150, category = 'valuesAndBeliefs', children, animate }: CircleProps) => {
  ...
  return (
    ...
    >
      ...
      <CircleTopLayer size={size + size / 9} colors={gradientColors} animate={animate} />
      <CircleMiddleLayer size={size + size / 9} colors={gradientColors} animate={animate} />
      <CircleBottomLayer size={size + size / 9} colors={gradientColors} animate={animate} />
    </div>
  );
};
