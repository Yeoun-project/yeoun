...
const QuestionListItem = ({ content, category, createTime, path }: QuestionListItemProps) => {
  return (
    <li className="flex w-full items-center justify-between gap-6 px-6 py-3">
      <div>
      ...
      <Link to={path} className="block w-full rounded-sm border border-white/50 bg-white/10 p-3">
